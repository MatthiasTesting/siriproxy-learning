...
class SiriProxy::Plugin::Learning < SiriProxy::Plugin
  ...
  listen_for /Detail zu (.*)/i do | page_id |
      ...
      @service = OData::Service.new "http://bfessfd.intern.itelligence.de:8000/sap/opu/odata/sap/ZLIST_SRV/FullPages('11')?sap-ds-debug=true", { :username => "mar", :password=> "Bachelor4711" }
        #say @service
